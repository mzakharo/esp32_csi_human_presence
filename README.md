...
# Human Presense Detector using WiFI CSI (Channel State Information)

Starts a task that sends NULL Data packets to the Access Point and receives ACKs

CSI is extracted from the ACKs and resulting data stream is fed to a presense detection algorithm
